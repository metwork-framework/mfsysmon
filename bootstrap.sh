...
export MFMODULE=MFSYSMON
export MFMODULE_LOWERCASE=mfsysmon
...
echo "export MFMODULE_VERSION := ${MFSYSMON_VERSION}" >>adm/root.mk
...
echo "export ${MFMODULE}_VERSION := ${MFSYSMON_VERSION}" >>adm/root.mk
